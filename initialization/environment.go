...
func printEnv(logger *zap.SugaredLogger) error {
	...
	logger.Infof("HTTP_ALARM_SERVER = %s", os.Getenv("HTTP_ALARM_SERVER"))
	logger.Infof("HTTP_ALARM_PORT = %s", os.Getenv("HTTP_ALARM_PORT"))
	logger.Infof("HTTP_ALARM_ONLINE_API = %s", os.Getenv("HTTP_ALARM_ONLINE_API"))
	logger.Infof("HTTP_ALARM_ALARMS_API = %s", os.Getenv("HTTP_ALARM_ALARMS_API"))
	logger.Infof("HTTP_ALARM_NOTIFICATIONS_API = %s", os.Getenv("HTTP_ALARM_NOTIFICATIONS_API"))
	logger.Infof("HTTP_ALARM_FCMTOKEN_API = %s", os.Getenv("HTTP_ALARM_FCMTOKEN_API"))
	logger.Infof("HTTP_ALARM_APITOKEN_API = %s", os.Getenv("HTTP_ALARM_APITOKEN_API"))
	logger.Infof("HTTP_ALARM_KEEPALIVE_API = %s", os.Getenv("HTTP_ALARM_KEEPALIVE_API"))
